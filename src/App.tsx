...
const App = () => {
  ...
  return <div className='block items-center'>
    <div className='px-2.5 py-2.5 mx-auto'>
      <TestimonialItem texto={Joke || 'Chuck Norris would take 1 second to code this app'}/>
      </div>
      <span className='flex justify-center px-1.5 py-1.5'>
        { loading ? 
             <svg role="status" className="w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-sky-500" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
